...
CHEMIN_CSV = r"C:\Users\dell\Desktop\xauusd_neuro_symbolic\XAUUSD_data_M1\XAUUSD_H1_Features_Final.csv"
df_final = pd.read_csv(CHEMIN_CSV, index_col="Datetime", parse_dates=True)
